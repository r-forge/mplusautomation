...
\date{Package version 0.2-3}
\maketitle
\tableofcontents
\bigskip
<<echo=FALSE>>=
	setwd("C:/Data_Analysis/Mplus_Automation/pkg/inst")
@
...
As of this version of the package (0.2-3), the following summary statistics are automatically extracted,
when available:
